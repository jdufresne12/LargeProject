    ...
    <SafeAreaView style={styles.container}>
      <ScrollView scrollEnabled={false}>
        ...
        <View style={styles.earth}>
          <Earth />
          {currentQuestion && (
            <TouchableOpacity style={styles.gameModeChoiceBtn} disabled={true}>
                  ...
                  <View key={index} style={styles.row}>
                    <TouchableOpacity
                      ...
                      onPress={() => {
                        ...
                        if (currentQuestionIndex === 9) {
                          ...
                          setIsTimerActive(false); // Add this line
                        }
                      }}
                    >
                      <Text>{option}</Text>
                    ...
                    {currentQuestion.options[index + 1] && (
                      <TouchableOpacity
                        ...
                        onPress={() => {
                          setCurrentQuestionIndex((prevIndex) => prevIndex + 1);
                          incrementCount(currentQuestion.options[index + 1]);
                          if (currentQuestionIndex === 9) {
                            setShowResultOverlay(true);
                            setIsTimerActive(false); // Add this line
                          }
                      ...
                      >
                        <Text>{currentQuestion.options[index + 1]}</Text>
                      </TouchableOpacity>
                    )}
                  </View>
                );
